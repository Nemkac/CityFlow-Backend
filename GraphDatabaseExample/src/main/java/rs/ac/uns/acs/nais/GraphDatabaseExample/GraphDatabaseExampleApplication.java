package rs.ac.uns.acs.nais.GraphDatabaseExample;
...
public class GraphDatabaseExampleApplication {

	public static void main(String[] args) {
		SpringApplication.run(GraphDatabaseExampleApplication.class, args);
	}
